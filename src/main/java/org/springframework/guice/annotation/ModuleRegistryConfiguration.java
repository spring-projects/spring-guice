...
class ModuleRegistryConfiguration implements BeanDefinitionRegistryPostProcessor, ApplicationContextAware, ApplicationListener<CreateInjectorSignalEvent> {
	...
	private void createInjector(List<Module> modules, ConfigurableListableBeanFactory beanFactory) {
		...
		try {
			Map<String, InjectorFactory> beansOfType = beanFactory.getBeansOfType(InjectorFactory.class);
...
/**
 * Signaling event used to trigger injector creation after BeanPostProcessors
 * have been applied.
 */
